...
import iceCraft.blocks.models.RefrigeratorModel;
...
public class TileEntityRefrigeratorRenderer extends TileEntitySpecialRenderer {
	// The model of your block
	private final RefrigeratorModel model;

	public TileEntityRefrigeratorRenderer() {
		this.model = new RefrigeratorModel();
	}
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z,
		...
		ResourceLocation textures = (new ResourceLocation(ModInfo.ID + ":"
				+ "textures/blocks/Refrigerator/Refrigerator.png"));
